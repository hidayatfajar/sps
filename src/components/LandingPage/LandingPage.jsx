...
import display3 from "../Assets/LandingPageImg/display3.png";
import display4 from "../Assets/LandingPageImg/display4.png";
import display5 from "../Assets/LandingPageImg/display5.png";
import display6 from "../Assets/LandingPageImg/display6.png";
import display7 from "../Assets/LandingPageImg/display7.png";
...
import icon8 from "../Assets/LandingPageImg/qr-icon.svg";
            ...
            <Navbar collapseOnSelect expand="lg" className="navbar">
              <Container>
                <Navbar.Brand href="#home">
                  ...
                  <span className="title1">Sistem Pembayaran Sekolah</span>
                  <span className="title2">SPS</span>{" "}
                </Navbar.Brand>
              ...
              <Row>
                <Col md={6}>
                  <div className="page1-content">
                    ...
                    <p>
                      Platform bagi murid dan orang tua untuk membayar keperluan
                      sekolah dari aplikasi pembayaran favorit mereka
                    </p>
                    <Link to="/user/login">
              ...
              <Row>
                ...
                <Col md={{ span: 5, offset: 2 }}>
                  <div className="page2-content">
                    <h1>
                      Melalui Banyak <br /> Metode Pembayaran
                    </h1>
              ...
              <Row>
                <Col md={4}>
                  <div className="page3-content">
                    ...
                    <p>
                      Semua tagihan seperti SPP, Uang Buku, Sumbangan dan
                      lain-lain, akan lebih mudah diinformasikan dan siswa dapat
                      memeriksa status pembayaran melalui web ini.
                    </p>
                  </div>
                </Col>
                        ...
                        <Slider {...settings}>
                          <div>
                            <span className="cover-img">
                              <Image className="img3" src={display1} />
                            </span>
                          </div>
                          <div>
                            <span className="cover-img">
                              <Image className="img3" src={display2} />
                            </span>
                          </div>
                          <div>
                            <span className="cover-img">
                              <Image className="img3" src={display3} />
                            </span>
                          </div>
                          <div>
                            <span className="cover-img">
                              <Image className="img3" src={display4} />
                            </span>
                          </div>
                          <div>
                            <span className="cover-img">
                              <Image className="img3" src={display5} />
                            </span>
                          </div>
                          <div>
                            <span className="cover-img">
                              <Image className="img3" src={display6} />
                            </span>
                          </div>
                          <div>
                            <span className="cover-img">
                              <Image className="img3" src={display7} />
                            </span>
                          </div>
                        </Slider>
                      </Container>
            ...
            <div className="container">
              <div className="page4-title">
                ...
                <p>
                  ...
                  penerimaan biaya pendidikan dan biaya lainnya <br />
                  yang terkait dengan penyelenggaraan pendidikan secara daring
                  ataupun tatap muka.
                </p>
              </div>
            </div>
                ...
                <Row>
                  <Col md={4} className="col">
                    <div className="contentBx">
                      ...
                      <p>
                        biaya pendidikan dapat mudah diintegrasikan dengan
                        sistem administrasi lembaga pendidikan.{" "}
                      </p>
                    </div>
                  </Col>
                  <Col md={4} className="col">
                    <div className="contentBx">
                      ...
                      <h2>Real Time</h2>
                      <p>
                        Data dapat diketahui setiap saat dan dapat diakses
                        secara online.{" "}
                      </p>
                    </div>
                  </Col>
                  <Col md={4} className="col">
                    <div className="contentBx">
                      ...
                      <h2>Details Info</h2>
                      <p>
                        Informasi lengkap untuk user riwayat transaksi dan
                        pembayaran yang perlu dibayar.{" "}
                      </p>
                    </div>
                  </Col>
                  <Col md={4} className="col">
                    <div className="contentBx">
                      ...
                      <p>
                        Layanan konsultasi bila informasi kurang jelas atau
                        tidak dapat dimengerti dll.
                      </p>
                    </div>
                  </Col>
                  <Col md={4} className="col">
                    <div className="contentBx">
                      ...
                      <h2>Qr Code</h2>
                      <p>
                        Qr Code ini berfungsi untuk memudahkan petugas Tata
                        Usaha mencari siswa yang ingin membayar.
                      </p>
                    </div>
                  </Col>
                  <Col md={4} className="col">
                    <div className="contentBx">
                      ...
                      <h2>Keamanan</h2>
                      <p>
                        Keamanan data pembayaran murid 100% tersimpan dengan
                        baik.
                      </p>
                    </div>
                  </Col>
            ...
            <Container>
              <div className="contentBox">
                <div className="title text-center">
                  <h3>
                    Apa <span style={{ borderBottom: "3px solid" }}>Kata</span>{" "}
                    Pengguna
                  </h3>
                </div>
                <br />
                      ...
                      <Row>
                        ...
                        <Col md={5}>
                          <div className="testimoni">
                            <h6>
                              "Web ini sangat simple dan praktis untuk staf Tata
                              usaha gunakan"
                            </h6>
                          </div>
                        </Col>
              ...
              <div className="footer-content">
                <Row>
                  <Col md={4} className="content1">
                    ...
                    <br />
                    <p>
                      Jl. Lap Bola Rawa Butun Ciketing Udik Bantargebang Kota
                      Bekasi 17153 Phone: (021) 82597121 Email:
                      smkn2kotabekasi@gmail.com
                    </p>
                  </Col>
                  <Col md={{ span: 2, offset: 2 }} className="content2">
                    <h4>About Us</h4>
                    <p>Profile sekolah Testimonials</p>
                  </Col>
